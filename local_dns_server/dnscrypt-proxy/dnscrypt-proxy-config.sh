...
cat accelerated-domains.china.conf | grep -v '^#server' | sed -e 's|/| |g' -e 's|^server= ||' | sed 's/114.114.114.114/202.38.93.153,202.141.162.123,114.114.114.114/g' >>dnscrypt-forwarding-rules.txt
